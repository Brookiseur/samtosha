 ...
 */
final class Version20230120091212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours DROP lieu, DROP horaire_de_debut, DROP horaire_de_fin, DROP day, DROP participant_min, DROP participant_max, DROP actualite');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours ADD lieu VARCHAR(255) DEFAULT NULL, ADD horaire_de_debut DATETIME DEFAULT NULL, ADD horaire_de_fin DATETIME DEFAULT NULL, ADD day VARCHAR(255) DEFAULT NULL, ADD participant_min INT DEFAULT NULL, ADD participant_max INT DEFAULT NULL, ADD actualite TINYINT(1) DEFAULT NULL');
    }
}
