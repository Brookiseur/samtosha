...
class RegistrationFormType extends AbstractType
{
    ...
    {
        $builder
            ->add('email',TextType::class, ["attr"=>["class"=>"inputfield"], "label_attr"=>["class"=>"labelform"]])
            ->add('name',TextType::class, ["attr"=>["class"=>"inputfield"], "label_attr"=>["class"=>"labelform"],"label"=>"Nom"])
            ->add('firstname',TextType::class, ["attr"=>["class"=>"inputfield"], "label_attr"=>["class"=>"labelform"],"label"=>"Prénom"])
